...
class TestsController extends AppController {
    ...
    public function index() {
        ...
        $indexInfo['description'] = "Client user list(post method)";
        ...
        $indexInfo['description'] = "Upload report(post method)";

        $indexInfo['url'] = FULL_BASE_URL . $this->webroot . "api/patients/uploadreport";

        $indexInfo['parameters'] = 'id:14 
                                    report:file <br>';
        
        $indexarr[] = $indexInfo;
        
        $indexInfo['description'] = "Client pending patients list(post method)";

        $indexInfo['url'] = FULL_BASE_URL . $this->webroot . "api/patients/clientpendinglist";

        $indexInfo['parameters'] = 'id:1175  <br>';
        
        $indexarr[] = $indexInfo;
        
        $indexInfo['description'] = "Client cancel patients list(post method)";

        $indexInfo['url'] = FULL_BASE_URL . $this->webroot . "api/patients/doctorcanceledpatientlist";

        $indexInfo['parameters'] = 'id:1175  <br>';
        
        $indexarr[] = $indexInfo;
        
        $indexInfo['description'] = "USer cancel patients list(post method)";

        $indexInfo['url'] = FULL_BASE_URL . $this->webroot . "api/patients/usercanceledpatientlist";

        $indexInfo['parameters'] = 'id:1248  <br>';
