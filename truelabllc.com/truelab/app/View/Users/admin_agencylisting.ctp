...
<section class="content">
 ...
 ?>
    ...
    <tr>
        ...
        <td class="actions">
            <?php echo $this->Html->link('', array('action' => 'viewagency', $user['User']['id']), array('class' => 'fa fa-eye btn btn-warning view1', 'title' => 'View')); ?>

            <?php echo $this->Html->link('', array('action' => 'editagency', $user['User']['id']), array('class' => 'btn btn-primary fa fa-pencil', 'title' => 'Edit')); ?>
			...
			<?php echo $this->Html->link('', array('action' => 'addagencymember', $user['User']['id']), array('class' => 'btn btn-success fa fa-plus', 'title' => 'Add Member')); ?>
