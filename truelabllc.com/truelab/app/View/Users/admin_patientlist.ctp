            ...
            <table style="font-size:12px;" id="example" class="table table-bordered table-hover" cellspacing="0" width="100%">
                ...
                ?>	 	
                    <tr>
                        ...
                        <td><?php echo $patient['Patient']['trackingid']; ?></td>
                        <td><?php echo $patient['Patient']['firstname'] . ' ' . $patient['Patient']['lastname']; ?></td>
...
<!--                    <td><?php echo $patient['Patient']['doctorfaxnumber']; ?></td>-->
                        <td><?php echo date('Y-m-d', strtotime($patient['Patient']['created'])); ?></td>
