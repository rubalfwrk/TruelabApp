            ...
            <a href="" class="logo">
                ...
                <?php }else{ ?>
                    <?php if($userlogagencyname != '') { ?>
                    	<span class="logo-lg"><b><?php echo $userlogagencyname; ?></b></span>
                    <?php }else{ ?>
                    	<span class="logo-lg"><b><?php echo $doctoruserlogname; ?></b></span>
                    <?php } ?> 
                <?php } ?>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
								...
								<?php }?>
                                    ...
                                    <p>
                                        <?php echo $loggedusername; ?> - <?php echo $usernamedata; ?>
...
<!--                                <li class="user-body">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <?php echo $this->Html->link('My Profile', array('controller' => 'users', 'action' => 'myaccount', 'admin' => true), array('class' => 'users_autorizemenu1 btn btn-default btn-flat')); ?>
                                    </div>
